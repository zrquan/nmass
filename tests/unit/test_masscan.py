...
def test_with_rate(masscan_instance):
    ...
    assert "--rate" in masscan_instance._args, f"Expected '--rate' in args, got {masscan_instance._args}"
    assert str(rate) in masscan_instance._args, f"Expected '{rate}' in args, got {masscan_instance._args}"


def test_with_banners(masscan_instance):
    masscan_instance.with_banners()
    assert "--banners" in masscan_instance._args, f"Expected '--banners' in args, got {masscan_instance._args}"
...
def test_with_config(masscan_instance):
    ...
    assert filename in masscan_instance._args, f"Expected '{filename}' in args, got {masscan_instance._args}"


def test_with_resume(masscan_instance):
    filename = "/path/to/resume.txt"
    masscan_instance.with_resume(filename)
    assert "--resume" in masscan_instance._args, f"Expected '--resume' in args, got {masscan_instance._args}"
    assert filename in masscan_instance._args, f"Expected '{filename}' in args, got {masscan_instance._args}"


def test_echo_config(masscan_instance):
    masscan_instance.echo_config()
    assert "--echo" in masscan_instance._args, f"Expected '--echo' in args, got {masscan_instance._args}"
...
def test_with_adapter(masscan_instance):
    ...
    assert interface in masscan_instance._args, f"Expected '{interface}' in args, got {masscan_instance._args}"


def test_with_adapter_ip(masscan_instance):
    ip = "192.168.1.1"
    masscan_instance.with_adapter_ip(ip)
    assert "--adapter-ip" in masscan_instance._args, f"Expected '--adapter-ip' in args, got {masscan_instance._args}"
...
def test_with_adapter_port(masscan_instance):
    ...
    assert str(port) in masscan_instance._args, f"Expected '{port}' in args, got {masscan_instance._args}"


def test_with_adapter_mac(masscan_instance):
    mac_address = "00:11:22:33:44:55"
    masscan_instance.with_adapter_mac(mac_address)
    assert "--adapter-mac" in masscan_instance._args, f"Expected '--adapter-mac' in args, got {masscan_instance._args}"
    assert mac_address in masscan_instance._args, f"Expected '{mac_address}' in args, got {masscan_instance._args}"


def test_with_router_mac(masscan_instance):
    router_mac = "66:77:88:99:AA:BB"
    masscan_instance.with_router_mac(router_mac)
    assert "--router-mac" in masscan_instance._args, f"Expected '--router-mac' in args, got {masscan_instance._args}"
    assert router_mac in masscan_instance._args, f"Expected '{router_mac}' in args, got {masscan_instance._args}"


def test_with_ping(masscan_instance):
    masscan_instance.with_ping()
    assert "--ping" in masscan_instance._args, f"Expected '--ping' in args, got {masscan_instance._args}"
...
def test_with_retries(masscan_instance):
    ...
    assert "--retries" in masscan_instance._args, f"Expected '--retries' in args, got {masscan_instance._args}"
    assert str(retries) in masscan_instance._args, f"Expected '{retries}' in args, got {masscan_instance._args}"
...
def test_with_http_user_agent(masscan_instance):
    ...
    assert user_agent in masscan_instance._args, f"Expected '{user_agent}' in args, got {masscan_instance._args}"


def test_without_closed_ports(masscan_instance):
    masscan_instance.without_closed_ports()
    assert "--open-only" in masscan_instance._args, f"Expected '--open-only' in args, got {masscan_instance._args}"


def test_with_pcap(masscan_instance):
    filename = "/path/to/output.pcap"
    masscan_instance.with_pcap(filename)
    assert "--pcap" in masscan_instance._args, f"Expected '--pcap' in args, got {masscan_instance._args}"
    assert filename in masscan_instance._args, f"Expected '{filename}' in args, got {masscan_instance._args}"
...
def test_with_pfring(masscan_instance):
    ...
    assert "--pfring" in masscan_instance._args, f"Expected '--pfring' in args, got {masscan_instance._args}"
...
def test_with_resume_index(masscan_instance):
    ...
    assert str(index) in masscan_instance._args, f"Expected '{index}' in args, got {masscan_instance._args}"
...
def test_with_resume_count(masscan_instance):
    ...
    assert str(count) in masscan_instance._args, f"Expected '{count}' in args, got {masscan_instance._args}"
...
def test_with_rotate(masscan_instance):
    ...
    assert "--rotate" in masscan_instance._args, f"Expected '--rotate' in args, got {masscan_instance._args}"
    assert time in masscan_instance._args, f"Expected '{time}' in args, got {masscan_instance._args}"
...
def test_with_rotate_offset(masscan_instance):
    ...
    assert offset in masscan_instance._args, f"Expected '{offset}' in args, got {masscan_instance._args}"


def test_with_rotate_dir(masscan_instance):
    directory = "/path/to/rotate"
    masscan_instance.with_rotate_dir(directory)
    assert "--rotate-dir" in masscan_instance._args, f"Expected '--rotate-dir' in args, got {masscan_instance._args}"
    assert directory in masscan_instance._args, f"Expected '{directory}' in args, got {masscan_instance._args}"


def test_with_seed(masscan_instance):
    seed = "123456"
    masscan_instance.with_seed(seed)
    assert "--seed" in masscan_instance._args, f"Expected '--seed' in args, got {masscan_instance._args}"
    assert seed in masscan_instance._args, f"Expected '{seed}' in args, got {masscan_instance._args}"


def test_with_regress(masscan_instance):
    masscan_instance.with_regress()
    assert "--regress" in masscan_instance._args, f"Expected '--regress' in args, got {masscan_instance._args}"


def test_with_ttl(masscan_instance):
    ttl = 64
    masscan_instance.with_ttl(ttl)
    assert "--ttl" in masscan_instance._args, f"Expected '--ttl' in args, got {masscan_instance._args}"
    assert str(ttl) in masscan_instance._args, f"Expected '{ttl}' in args, got {masscan_instance._args}"


def test_with_wait(masscan_instance):
    seconds = 10
    masscan_instance.with_wait(seconds)
    assert "--wait" in masscan_instance._args, f"Expected '--wait' in args, got {masscan_instance._args}"
    assert str(seconds) in masscan_instance._args, f"Expected '{seconds}' in args, got {masscan_instance._args}"


def test_with_offline(masscan_instance):
    masscan_instance.with_offline()
    assert "--offline" in masscan_instance._args, f"Expected '--offline' in args, got {masscan_instance._args}"
